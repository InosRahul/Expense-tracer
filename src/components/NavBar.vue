      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li v-if="isAuthenticated" class="nav-item">
              <router-link to="/addexpenses" class="nav-link">Add</router-link>
            </li>
            <li v-if="isAuthenticated" class="nav-item">
              <router-link to="/deleteexpenses" class="nav-link">Delete</router-link>
            </li>
            <li v-if="isAuthenticated" class="nav-item">
              <router-link to="/updateexpenses" class="nav-link">Update</router-link>
            </li>
          </ul>
